                        ...
                        <td>
                            <ul class="search-results">
                                <li class="result-list aos-item" data-aos-duration="200" data-aos-delay="100"  style="border-radius: 5px; border-color: #3050cd">
                                    <font style="font-family: 'Material-Design-Iconic-Font', serif; font-size:90%; color: #0d10a3"><b>26010/22.05.2025/0030137</b></font>
                                </li>
                            </ul>
                        </td>
                    </tr>
                        ...
                        <td>
                            <ul class="search-results">
                                <li class="result-list aos-item" data-aos-duration="400" data-aos-delay="100"  style="border-radius: 5px; border-color: #3050cd">
                                    <font style="font-family: 'Material-Design-Iconic-Font', serif; font-size:90%; color: #0d10a3">22.05.2025 19:43:32</font>
                                </li>
                            </ul>
                        </td>
                    </tr>
                        ...
                        <td>
                            <ul class="search-results">
                                <li class="result-list aos-item" data-aos-duration="600" data-aos-delay="100"  style="border-radius: 5px; border-color: #3050cd">
                                    <font style="font-family: 'Material-Design-Iconic-Font', serif; font-size:90%; color: #0d10a3">23.05.2025 11:38:34</font>
                                </li>
                            </ul>
                        </td>
                    </tr>
                        ...
                        <td>
                            <ul class="search-results">
                                <li class="result-list aos-item" data-aos-duration="1600" data-aos-delay="100"  style="border-radius: 5px; border-color: #3050cd">
                                    <div style="margin-bottom: -5px; margin-top: -5px">
                                    <font style="font-family: 'Material-Design-Iconic-Font', serif; font-size:90%; color: #0d10a3">03002 - "Дустлик" ЧП</font>
                                        </div>
                                </li>
                            </ul>
                        </td>
                                        ...
                                        <div style="margin-bottom: -5px; margin-top: -5px; width: 100%">
                                            <div style="overflow: auto; width: 370px;">
                                                <table style="width: 100%; font-family: 'Material-Design-Iconic-Font', serif; font-size:90%; color: #0d10a3" border="1">
                                                    ...
                                                    <td align="center"><textarea style="width: 200px; font-family: 'Material-Design-Iconic-Font', serif; font-size:90%; color: #0d10a3">1. Автомобиль легковой,марки:"BEIJING BJ60", модель: BJ2030V60MSHEV, новый, объем двиг.: 1498 см3, 2025 год. вып.,Тип авто:Кроссовер, Пос..мест:7(вкл. вод.),VIN:LNBRDFHK1SB679016, двиг. № V001R058269, модел двигател: A156T2H, Цвет: Черый,Тип двиг.:(электродвигатель+двигатель с искровым зажиганием), Привод:Полный, Изготовитель: BAIC Motor Off-Road Vehicle Co,LTD. Китай, № кузова:LNBRDFHK1SB679016, № двиг.: V001R058269, об. дв. 1498см3, цвет черный,  электрический, 2025г.в. - кол. 1 шт, вес: 2800</textarea></td>
                        ...
                        <td>
                            <ul class="search-results">
                                <li class="result-list aos-item" data-aos-duration="2000" data-aos-delay="100"  style="border-radius: 5px; border-color: #3050cd">
                                    ...
                                    <font style="font-family: 'Material-Design-Iconic-Font', serif; font-size:90%; color: #0d10a3">2 800,000 кг.</font>
                                        ...
                                        <tr>
                                            ...
                                            <td style="width: 99%" align="center">
                                                ...
                                                <img src="/PersonCabinet/template/print_decl/pdf_1850.png" alt="user"
                                                     style="width: 30px">&nbsp;&nbsp;
                                                <a href="/PersonCabinet/download_print?decl_id=196f86ea9f8_1_ugtd">
                                                    <font style="font-family: 'Material-Design-Iconic-Font', serif; font-size: 100%; color: #ffffff">
